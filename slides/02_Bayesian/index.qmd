...
* PhD in Zoology at UBC
* field ecologist who likes stats too much ;) 
* R user and recent convert to Bayesian stats

## Outline of today

* Overview of frequentist and bayesian statistics
* Brief intro to GLMs
* some practical advice on a Bayesian workflow with a (VERY) simple example.
* Discussion, practice exercises, and time for our own projects.
...
In introductory statistics course, it is common to rely on the frequentist paradigm.
::: 
...
## The GLMM: an ecologist's ultrasound

[![](../img/kidney.jpeg){width=1000 height=500}]

* easy to use
* available
* important to avoid seeing mirages
* Not the ideal tool but the one we have to work with!
